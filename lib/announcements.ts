...
export const announcements: Announcement[] = [
  {
    ...
    title: "ITCA 官网服务说明",
    date: "2026-05-16",
    summary: "本网站用于发布协会介绍、认证申请、会员申请、证书公开核验与合作联系等信息服务。",
    body: [
      "ITCA 官网开放协会基础信息服务，内容包括协会介绍、认证体系说明、个人会员申请、机构会员申请、证书公开核验与联系合作入口。",
  ...
  },
  {
    ...
    title: "ITCA 道教文化认证建档申请通道开放说明",
    date: "2026-05-16",
    summary: "当前开放道教文化认证建档申请，用于资料审核、记录建档、证书公开核验与文化交流场景中的参考信息。",
    body: [
      "ITCA 当前开放道教文化认证建档申请通道。申请人可通过官网提交身份资料、师承信息、修学经历、实践说明及相关证明材料。",
  ...
  },
  {
    ...
    title: "ITCA 证书公开核验功能说明",
    date: "2026-05-16",
    summary: "证书公开核验入口用于公众核验公开证书信息，证书状态以官网核验结果为准。",
    body: [
      "ITCA 官网已建设证书公开核验入口。公众可通过证书编号与持证人姓名核验公开证书信息。",
      "证书公开核验结果仅展示公开核验所需信息，不展示申请编号、联系方式、上传材料、审核反馈或内部备注。",
