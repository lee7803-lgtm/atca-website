...
app.MapPatch(
    "/api/admin/applications/{id:guid}/admin-note",
    async (
        HttpRequest httpRequest,
        Guid id,
    ...
    ) =>
    {
        try
        {
            ...
            var application = await commands.UpdateAdminNoteAsync(id, request, GetAdminActorContext(httpRequest), cancellationToken);
            if (application is null)
            {
                return Results.NotFound(new
                {
...
app.MapPatch(
    "/api/admin/applications/{id:guid}/contact",
    async (
        HttpRequest httpRequest,
        Guid id,
    ...
    ) =>
    {
        try
        {
            ...
            var application = await commands.UpdateContactAsync(id, request, GetAdminActorContext(httpRequest), cancellationToken);
            if (application is null)
            {
                return Results.NotFound(new
                {
