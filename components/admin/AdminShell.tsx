  ...
  return (
    <div className="min-h-screen bg-[#f5efe4] text-ink">
      <div className="mx-auto flex min-h-screen max-w-[1600px]">
        <aside className="sticky top-0 hidden h-screen w-64 shrink-0 border-r border-[#e4ded0] bg-[#fbf8ef]/95 px-4 py-5 lg:block">
          ...
          <div className="absolute bottom-5 left-4 right-4 grid gap-2 border-t border-[#e4ded0] pt-4">
