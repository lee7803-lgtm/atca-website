...
export function FormTemplateHelper({ hint, template, onApply }: FormTemplateHelperProps) {
  return (
    <div className="mt-3 rounded-xl border border-[#e4ded0] bg-[#fbf8ef] p-4 text-xs leading-6 text-[#66594d]">
      ...
      <details className="mt-3">
        ...
        <pre className="mt-3 whitespace-pre-wrap rounded-lg bg-white/70 p-3 font-sans text-xs leading-6 text-[#5f5b52]">{template}</pre>
      </details>
