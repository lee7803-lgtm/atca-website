...
const items = [
  { badge: "V2.0", title: "注册用户", text: "面向普通访问者、文化爱好者和申请人，承接登录、资料维护、通知接收和既有申请绑定。" },
  { badge: "V2.0", title: "会员用户", text: "关联个人会员与机构会员申请记录，展示会员状态、有效期、续期提示和会员公开核验入口。" },
  { badge: "V2.0", title: "认证申请人", text: "关联认证申请、材料补正、证书状态和公开核验结果，不改变 V1.3 认证审核流程。" },
  { badge: "V2.0", title: "机构账号", text: "用于机构会员、合作机构、发展中心项目和数据中心入驻资料维护。" },
...
export default function AdminUsersPage() {
  ...
  return (
    <AdminV2Page
      ...
      eyebrow="Users"
      intro="用户管理用于规划 V2.0 注册用户、会员、认证申请人、机构账号和历史申请绑定能力。本页面不写入数据库。"
      items={items}
      notice="当前仍保留 ADMIN_PASSWORD fallback。正式用户系统需要先人工确认并执行 SQL 草案，本轮不执行 SQL、不修改数据库。"
      title="用户管理"
    >
      <AdminSectionCard title="绑定策略">
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          {[
            ["申请编号 + 联系方式", "用于绑定个人会员、机构会员和认证申请，保留 V1.3 查询校验方式。"],
