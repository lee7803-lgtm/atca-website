    ...
    <>
      <section className="paper-wash relative overflow-hidden border-b border-[#e4ded0]">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-20">
          <p className="mb-4 text-xs font-medium uppercase tracking-[0.28em] text-gold">Individual Member</p>
          <h1 className="font-serif text-4xl leading-tight text-porcelain sm:text-6xl">个人会员申请</h1>
          <p className="mt-4 font-serif text-2xl leading-snug text-[#8a6b3e]">Individual Membership Application</p>
          <p className="mt-6 max-w-3xl text-lg leading-9 text-[#5f5148]">
            个人会员申请用于登记申请人的个人身份、联系方式、道教文化学习或修持背景、所属道堂及介绍人信息。申请资料将用于会员审核、档案管理及协会后续沟通。
          </p>
        </div>
      </section>
      ...
      <main className="mx-auto max-w-6xl px-5 py-12 sm:px-8 lg:py-16">
        <div className="border-l-4 border-[#7F1D1D] bg-[#fbf8ef] p-5 text-sm leading-8 text-[#5f5b52] shadow-[0_16px_45px_rgba(176,138,69,0.08)]">
          请按步骤填写个人会员申请资料。带 <span className="font-semibold text-[#7F1D1D]">*</span> 的项目为必填项，其他资料可按实际情况补充。线上提交服务暂未开放，申请资料提交方式以后续协会正式通知为准。
        </div>
